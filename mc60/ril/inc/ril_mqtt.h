...
#define MQTT_MAX_TOPIC 5   // یا 1..5 (بسته به نیازت)
#endif
...
/******************************************************************************
* Function:     RIL_MQTT_QMTCFG_Showrecvlen
*
* Description:
*               Whether to display the received data length.This command must be added to use MQTT under OPEN.
*
* Parameters:
*               connectID:
*                   [in]
...
*               show_flag:
*                   [in]
*                    Whether to display the received data length.0-not show,1-show.
* Return:
*                RIL_AT_SUCCESS, or other Error Codes.
*                RIL_AT_FAILED, send AT failed.
*                RIL_AT_TIMEOUT,send AT timeout.
